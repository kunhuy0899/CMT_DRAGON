    ...
    render() {
        ...
        <div className="row">
          <article className="col-md-9 mt-5">
            ...
            <div className="col-md-12 ">
              <div style={{float: 'left', fontSize: '17px'}} className="bbp-breadcrumb col-md-12"><p><a href="https://qntdata.com" className="bbp-breadcrumb-home" style={{color: 'coral'}}>Home</a> <span className="bbp-breadcrumb-sep">›</span> <span className="bbp-breadcrumb-current" style={{color: 'coral'}}>Forums</span><span className="bbp-breadcrumb-sep"> ›</span> <span className="bbp-breadcrumb-current">QT-Forums</span></p></div>
              <div className="col-md-12 ">
                <ul>
                  <li>
                    "This forum has 8 topics, and was last updated " 
                    <a href title="Reply To: AI trong Hospitality">7 months, 1 week ago</a>
                    <a href="https://qntdata.com/forums/users/admin1/" title="View admin1's profile" className="bbp-author-link"><span className="bbp-author-avatar"><img alt="" src="https://secure.gravatar.com/avatar/8c75eba721909a03b06df864961504eb?s=14&d=mm&r=g" srcSet="https://secure.gravatar.com/avatar/8c75eba721909a03b06df864961504eb?s=28&d=mm&r=g 2x" className="avatar avatar-14 photo" height={14} width={14} loading="lazy" /></span><span className="bbp-author-name"> admin1</span></a>
                  </li>
                </ul>
              </div>
              <div className="bbp-pagination col-md-12">
                <div className="bbp-pagination-count">Viewing 8 topics - 1 through 8 (of 8 total)</div><br />
              </div>
              <div className="table-responsive text-nowrap">
                ...
                <table className="table table-striped" style={{fontSize: '13px'}}>
                  ...
                  <tbody className>
                    <tr>
                      <th scope="row"><a className="bbp-topic-permalink" style={{color: '#d86d0e'}}>AI trong Hospitality</a>
                        <p className="bbp-topic-meta">
                          <span className="bbp-topic-started-by">Started by: <a href title="View Admin HR's profile" className="bbp-author-link"><span className="bbp-author-avatar"><img alt="" src="https://secure.gravatar.com/avatar/109b2e55020d62f76560742a17a51410?s=14&d=mm&r=g" srcSet className="avatar avatar-14 photo" height={14} width={14} loading="lazy" /></span><span className="bbp-author-name" style={{color: '#d86d0e'}}>Admin HR</span></a></span>
                        </p></th>
                      <td>2</td>
                      <td>2</td>
                      <td><a href title="Reply To: AI trong Hospitality" style={{color: '#d86d0e'}}>7 months, 1 week ago</a>
                        <p className="bbp-topic-meta">
                          <span className="bbp-topic-freshness-author"><a href title="View admin1's profile" className="bbp-author-link"><span className="bbp-author-avatar"><img alt="" src="https://secure.gravatar.com/avatar/8c75eba721909a03b06df864961504eb?s=14&d=mm&r=g" srcSet="https://secure.gravatar.com/avatar/8c75eba721909a03b06df864961504eb?s=28&d=mm&r=g 2x" className="avatar avatar-14 photo" height={14} width={14} loading="lazy" /></span><span className="bbp-author-name" style={{color: '#d86d0e'}}>admin1</span></a></span>
                        </p> </td>
                    </tr>
                    <tr>
                      <th scope="row"><a className="bbp-topic-permalink" style={{color: '#d86d0e'}}>Bitcoin</a>
                        <p className="bbp-topic-meta">
                          <span className="bbp-topic-started-by">Started by: <a href title="View Admin HR's profile" className="bbp-author-link"><span className="bbp-author-avatar"><img alt="" src="https://secure.gravatar.com/avatar/109b2e55020d62f76560742a17a51410?s=14&d=mm&r=g" srcSet className="avatar avatar-14 photo" height={14} width={14} loading="lazy" /></span><span className="bbp-author-name" style={{color: '#d86d0e'}}>Selena.ltht</span></a></span>
                        </p></th>
                      <td>2</td>
                      <td>2</td>
                      <td><a href title="Reply To: AI trong Hospitality" style={{color: '#d86d0e'}}>7 months, 1 week ago</a>
                    ...
                    <tr>
                      <th scope="row"><a className="bbp-topic-permalink" style={{color: '#d86d0e'}}>Blockchain</a>
                        <p className="bbp-topic-meta">
                          <span className="bbp-topic-started-by">Started by: <a href title="View Admin HR's profile" className="bbp-author-link"><span className="bbp-author-avatar"><img alt="" src="https://secure.gravatar.com/avatar/109b2e55020d62f76560742a17a51410?s=14&d=mm&r=g" srcSet className="avatar avatar-14 photo" height={14} width={14} loading="lazy" /></span><span className="bbp-author-name" style={{color: '#d86d0e'}}>Admin HR</span></a></span>
                        </p></th>
                      <td>2</td>
                    ...
                    <tr>
                      <th scope="row"><a className="bbp-topic-permalink" style={{color: '#d86d0e'}}>Phí website</a>
                        <p className="bbp-topic-meta">
                          <span className="bbp-topic-started-by">Started by: <a href title="View Admin HR's profile" className="bbp-author-link"><span className="bbp-author-avatar"><img alt="" src="https://secure.gravatar.com/avatar/109b2e55020d62f76560742a17a51410?s=14&d=mm&r=g" srcSet className="avatar avatar-14 photo" height={14} width={14} loading="lazy" /></span><span className="bbp-author-name" style={{color: '#d86d0e'}}>Admin HR</span></a></span>
                        </p></th>
                      <td>2</td>
                    ...
                    <tr>
                      <th scope="row"><a className="bbp-topic-permalink" style={{color: '#d86d0e'}}>Import Files to Hubspot</a>
                        <p className="bbp-topic-meta">
                          <span className="bbp-topic-started-by">Started by: <a href title="View Admin HR's profile" className="bbp-author-link"><span className="bbp-author-avatar"><img alt="" src="https://secure.gravatar.com/avatar/109b2e55020d62f76560742a17a51410?s=14&d=mm&r=g" srcSet className="avatar avatar-14 photo" height={14} width={14} loading="lazy" /></span><span className="bbp-author-name" style={{color: '#d86d0e'}}>Chau Tran</span></a></span>
                        </p></th>
                      <td>2</td>
                      <td>2</td>
                      <td><a href title="Reply To: AI trong Hospitality" style={{color: '#d86d0e'}}>7 months, 1 week ago</a>
                    ...
                    <tr>
                      <th scope="row"><a className="bbp-topic-permalink" style={{color: '#d86d0e'}}>Meeting schedule in Google calendar with Google Sheets data</a>
                        <p className="bbp-topic-meta">
                          <span className="bbp-topic-started-by">Started by: <a href title="View Admin HR's profile" className="bbp-author-link"><span className="bbp-author-avatar"><img alt="" src="https://secure.gravatar.com/avatar/109b2e55020d62f76560742a17a51410?s=14&d=mm&r=g" srcSet className="avatar avatar-14 photo" height={14} width={14} loading="lazy" /></span><span className="bbp-author-name" style={{color: '#d86d0e'}}>armani</span></a></span>
                        </p></th>
                      <td>2</td>
                      <td>2</td>
                      <td><a href title="Reply To: AI trong Hospitality" style={{color: '#d86d0e'}}>7 months, 1 week ago</a>
                    ...
                    <tr>
                      <th scope="row"><a className="bbp-topic-permalink" style={{color: '#d86d0e'}}>Làm sao tuyển 500 nhân viên</a>
                        <p className="bbp-topic-meta">
                          <span className="bbp-topic-started-by">Started by: <a href title="View Admin HR's profile" className="bbp-author-link"><span className="bbp-author-avatar"><img alt="" src="https://secure.gravatar.com/avatar/109b2e55020d62f76560742a17a51410?s=14&d=mm&r=g" srcSet className="avatar avatar-14 photo" height={14} width={14} loading="lazy" /></span><span className="bbp-author-name" style={{color: '#d86d0e'}}>xuanloi1702</span></a></span>
                        </p></th>
                      <td>2</td>
                      <td>2</td>
                      <td><a href title="Reply To: AI trong Hospitality" style={{color: '#d86d0e'}}>7 months, 1 week ago</a>
              ...
              {/*Table*/}
              <div className="col-md-12">Viewing 8 topics - 1 through 8 (of 8 total)</div><br />
              <div className="col-md-12" style={{border: '1px solid #eee', width: '100%', height: '180px'}}>
                <form className="form-group">
                  <label /><br />
                  <label className="col-md-6">Username:</label> 
                  <input type name className="col-md-5" /><br />
                  <label className="col-md-6">Password:</label> 
                  <input type name className="col-md-5" /><br />
                  <label className="checkbox col-md-3"><input type="checkbox" name="rememberme" defaultValue="forever" id="rememberme" /></label>
                  <label htmlFor="rememberme" className="col-md-8">Keep me signed in</label>
                  <button style={{float: 'right', background: '#f28728', color: '#fff', border: 'none'}}>Login</button>
                </form> 
              </div>
