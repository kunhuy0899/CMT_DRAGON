                    ...
                    <div className="row">
                                ...
                                <div className="card-body">
                                    <form name="frmBonus">
                                        <div className="form-group">
                                            ...
                                            <input type name="txtFullname" minLength={10} requied ng-model="name" className="form-control" /><br />
                                        </div>
                                        <div className="form-group">
                                            <label>Pasword</label>
                                            <span style={{ color: 'orangered' }}>*</span>
                                            <input type="password" name="txtSalary" min={2000000.0} ng-model="salary" className="form-control" />
                                        </div>
                                        <div className="form-group">
                                        ...
                                        <button className="btn btn-success" style={{ background: 'coral', border: '1px solid coral', float: 'right' }} type="submit">LOGIN</button>
                                        <div className="lost">
                                            <p>
                        ...
                        <aside className="col-md-3">
                            ...
                            <div className="post">
                                ...
                                <div className="mt-4">
                                    <a href="#"><img src="https://secureservercdn.net/198.71.233.138/d0y.65e.myftpupload.com/wp-content/uploads/2019/09/blog-Overview-of-blockchain-and-bitcoin-Part-4-78x78.jpg" width="78px" height="78px" style={{ marginRight: '5px' }} /></a>
                                    <a href="#"><img src="https://secureservercdn.net/198.71.233.138/d0y.65e.myftpupload.com/wp-content/uploads/2019/09/blog-Overview-of-blockchain-and-bitcoin-Part-3-78x78.jpg" width height style={{ marginRight: '5px' }} /></a>
                                    <a href="#"><img src="https://secureservercdn.net/198.71.233.138/d0y.65e.myftpupload.com/wp-content/uploads/2019/09/blog-Overview-of-blockchain-and-bitcoin-Part-2-78x78.jpg" width height style={{ marginRight: '5px' }} /></a>
                                    <a href="#"><img src="https://secureservercdn.net/198.71.233.138/d0y.65e.myftpupload.com/wp-content/uploads/2019/08/blog-Overview-of-blockchain-and-bitcoin-Part-1-78x78.jpg" width height style={{ marginTop: '5px' }} /></a>
                                </div>
                                <div className="mt-4">
                                ...
                                <div className="mt-4">
                                    <a href="#"><img src="https://i.pinimg.com/90x90/f1/c1/d2/f1c1d2c01d9665c65e73a471a608791e--trendy-website.jpg" width="78px" height="78px" style={{ marginRight: '5px' }} /></a>
                                    <a href="#"><img src="https://i.pinimg.com/90x90/7a/66/8e/7a668ee99e436676452148d02803f04d--wordpress-theme.jpg" width="78px" height="78px" style={{ marginRight: '5px' }} /></a>
                                    <a href="#"><img src="https://i.pinimg.com/90x90/8c/41/dd/8c41dd80bfc446c4f687aecb67a19941--wordpress-theme-website.jpg" width="78px" height="78px" style={{ marginRight: '5px' }} /></a>
                            ...
                            <div className="accordion" id="accordionExample">
                                <div className="card">
                                    <div className="card-header" id="headingOne" style={{ background: 'white' }}>
                                        <h2 className="mb-0">
                                            <button className="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" style={{ color: 'black', fontSize: '10pt', textDecoration: 'none', fontWeight: 'bold' }}>
                                                Accordion item
                        </button>
                                        </h2>
                                    </div>
                                ...
                                <div className="card">
                                    <div className="card-header" id="headingTwo" style={{ background: 'white' }}>
                                        <h2 className="mb-0" style={{ color: 'black !important', fontSize: '12pt' }}>
                                            <button className="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" style={{ color: 'black ', fontSize: '10pt', textDecoration: 'none', fontWeight: 'bold' }}>
                                ...
                                <div className="card">
                                    <div className="card-header" id="headingThree" style={{ background: 'white' }}>
                                        <h2 className="mb-0">
                                            <button className="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree" style={{ color: 'black ', fontSize: '10pt', textDecoration: 'none', fontWeight: 'bold' }}>
                                ...
                                <div className="card">
                                    <div className="card-header" id="headingFour" style={{ background: 'white' }}>
                                        <h2 className="mb-0">
                                            <button className="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour" style={{ color: 'black', fontSize: '10pt', textDecoration: 'none', fontWeight: 'bold' }}>
                                                Accordion item
                        </button>
                                        </h2>
                                    </div>
                                    <div id="collapseFour" className="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                                        <div className="card-body" style={{ color: '#888 ', fontSize: '10pt' }}>
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellen tesque diam sem, hendrerit ut faucibus sit amet, bibendum vel lacus. Nunc molestie magna sed sapien ornare tempus. Curabitur venenatis ipsum nec ligula.                      </div>
                                    </div>
                                </div>
                            </div>
